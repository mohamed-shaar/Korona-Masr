...
export const HOSPITALS: HospitalItem[] = [
  ...
  {
    place: 'عين شمس- السلام أول- السلام ثان - المرج', hospitals: 'مستشفى عين شمس',
    number: '16096 - 0224024111 - 0224022843 - 0222618189 - 0224024158',
  },
  ...
  private getSortedData(data: HospitalItem[]) {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort.active) {
        case 'hospitals':
          return compare(a.hospitals, b.hospitals, isAsc);
        case 'place':
